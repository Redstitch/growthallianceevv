...
const Post = ({ data }) => (
  <Layout>
    <Dochead
      ...
      pageImage={
        data.wordpressPost.acf.main_image &&
        data.wordpressPost.acf.main_image.url
      }
      description={
        data.wordpressPost.acf.description
          ? data.wordpressPost.acf.description
    ...
    />
    <RelatedPosts
      currentPost={data.wordpressPost.slug}
      category={data.wordpressPost.acf.primary_category.slug}
    />
  </Layout>
);
