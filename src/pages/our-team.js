      ...
      render={data => (
        <>
          <Dochead
            ...
            pageImage={
              data.wordpressAcfOptions.options.team_banner_image &&
              data.wordpressAcfOptions.options.team_banner_image.url
            }
          ...
          <DefaultBanner
            page={{
              ...
              color: 'navy',
              description:
                data.wordpressAcfOptions.options.team_banner_copy.copy,
            }}
            content={{
              overlay_color: 'navy',
            }}
